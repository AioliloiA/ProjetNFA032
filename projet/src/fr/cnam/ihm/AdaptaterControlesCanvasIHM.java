...
/**
   Adaptater d'implémentation par defaut de l'interface utilisée par le constructeur de CanvasHM permettant de traiter les clics dans la grille et dans le canvas
 */
