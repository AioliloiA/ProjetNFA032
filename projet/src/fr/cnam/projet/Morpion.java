...
public class Morpion
{
  ...
  final private static int NB_COLONNE=40;
  ...
  final private static int MAX_T = 5;
  ...
  public void demarrer()
  {
    ...
    //
    grille = pfjeu.getIhm().creerGrille(NB_COLONNE,NB_LIGNE,18);
  ...
  // Methode qui raye les pions d'une ligne si > 5
  //
                                ...
                                int x, int y)
  {
    ...
    // Si la ligne trouvee est de longueur >= 5 alors
    //  on raye la ligne et incremente les scores
    //
    if (tmp.size()>=5)
      {
        for(Point p:tmp)
